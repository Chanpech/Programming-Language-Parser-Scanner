...
struct expr * partial_result = 0;
struct expr * parser_array[16];
int arrayIndex = 0;
%}
...
program :  terminate TOKEN_PROGTERM
		{parser_result= $1; return 0; }
	;
terminate: 
	|	expr TOKEN_SEMI terminate
		{ parser_array[arrayIndex]= $1; arrayIndex++; $$ = expr_create(EXPR_SEMI, $1, 0); }
	|	expr
		{  $$ = $1; }
	;
